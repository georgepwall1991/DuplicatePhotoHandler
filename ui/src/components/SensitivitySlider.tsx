...
export function SensitivitySlider({ threshold, onThresholdChange }: SensitivitySliderProps) {
  ...
  return (
    <motion.div 
      ...
      className="glass-card  p-6 transition-all duration-300 border-white/5"
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <motion.span 
          ...
          className={`text-[10px] font-bold px-3 py-1.5  uppercase tracking-widest border border-white/5 ${getSensitivityColor(threshold)}`}
        >
      ...
      <div className="relative h-12 flex items-center">
        ...
        <motion.div 
          ...
          transition={{ type: "spring", stiffness: 300, damping: 30 }}
          className="absolute w-6 h-6 bg-white  shadow-[0_0_20px_rgba(255,255,255,0.4)] pointer-events-none -ml-3 flex items-center justify-center"
        >
